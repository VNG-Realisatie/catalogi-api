...
MAPPING = BASE_MAPPING + (
    ("datamodel.ZaakTypenRelatie", "gerelateerd_zaaktype", *ZTC),
    ("datamodel.ResultaatType", "resultaattypeomschrijving", *VRL),
    ("datamodel.ResultaatType", "selectielijstklasse", *VRL),
    ("datamodel.ZaakType", "selectielijst_procestype", *VRL),
)
