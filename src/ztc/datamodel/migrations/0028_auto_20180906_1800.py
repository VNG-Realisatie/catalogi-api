...
class Migration(migrations.Migration):
    ...
    dependencies = [("datamodel", "0027_auto_20180906_1748")]

    operations = [
        migrations.RemoveField(model_name="besluittype", name="publicatietermijn"),
        migrations.RemoveField(model_name="besluittype", name="reactietermijn"),
