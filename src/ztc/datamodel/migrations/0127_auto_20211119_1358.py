    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objecttype', models.URLField(help_text='URL-referentie naar de OBJECTTYPE waartoe dit ZAAKOBJECTTYPE behoort.', verbose_name='Objecttype')),
                ('relatie_omschrijving', models.CharField(help_text='Omschrijving van de betrekking van het Objecttype op zaken van het gerelateerde ZAAKTYPE.', max_length=80, verbose_name='Relatie omschrijving')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(help_text='De ZAAKOBJECTTYPEn die verplicht gerelateerd moeten zijn aan ZAAKen van dit ZAAKTYPE voordat een resultaat van dit RESULTAATTYPE kan worden gezet.', related_name='resultaattypen', to='datamodel.ZaakObjectType', verbose_name='Zaakobjecttypen'),
        ),
        migrations.AddField(
            model_name='statustype',
            name='zaakobjecttype',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='statustypen', to='datamodel.ZaakObjectType', verbose_name='Zaakobjecttypen'),
        ),
    ]
