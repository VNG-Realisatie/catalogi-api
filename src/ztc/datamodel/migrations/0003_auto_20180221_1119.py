...
class Migration(migrations.Migration):
    ...
    dependencies = [("datamodel", "0002_auto_20180130_1059")]

    operations = [
        migrations.AlterModelOptions(
            name="besluittype",
            options={
                "ordering": ("maakt_deel_uit_van", "besluittype_omschrijving"),
        ...
        migrations.AlterModelOptions(
            name="eigenschap",
            options={
                "ordering": ("is_van", "eigenschapnaam"),
        ...
        migrations.AlterModelOptions(
            ...
            options={
                "ordering": ("maakt_deel_uit_van", "informatieobjecttype_omschrijving"),
        ...
        migrations.AlterModelOptions(
            name="resultaattype",
            options={
                "ordering": ("is_relevant_voor", "resultaattypeomschrijving"),
        ...
        migrations.AlterModelOptions(
            name="roltype",
            options={
                "ordering": ("is_van", "roltypeomschrijving"),
        ...
        migrations.AlterModelOptions(
            name="statustype",
            options={
                "ordering": ("is_van", "statustypevolgnummer"),
        ...
        migrations.AlterModelOptions(
            name="zaaktype",
            options={
                "ordering": ("maakt_deel_uit_van", "zaaktype_identificatie"),
