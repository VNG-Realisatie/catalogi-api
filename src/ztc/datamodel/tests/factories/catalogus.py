...
class CatalogusFactory(factory.django.DjangoModelFactory):
    ...
    contactpersoon_beheer_naam = factory.Sequence(lambda n: 'Contact persoon beheer {}'.format(n))
    contactpersoon_beheer_telefoonnummer = '0612345678'
    contactpersoon_beheer_emailadres = factory.Sequence(lambda n: 'contact_{}@example.com'.format(n))
