...
class BesluitType(GeldigheidMixin, models.Model):
    ...
    **Toelichting objecttype**
    ...
    publicatie_indicatie = models.BooleanField(
        _('publicatie indicatie'), null=False,
    ...
    publicatietermijn = DaysDurationField(
        _('publicatietermijn'), blank=True, null=True,
    ...
    resultaattypes = models.ManyToManyField(
        ...
        help_text=_('(inverse van:) Het BESLUITTYPE van besluiten die gepaard gaan '
